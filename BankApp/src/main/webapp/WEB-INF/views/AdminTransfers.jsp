...
<body>
    ...
    <a href="<c:url value='/adminControl?command=TRANSACTIONS&type=transfer'/>" class="btn">Reset</a>
</form>
	
	<div class="table-container">
	    <table class="styled-table">
	        <thead>
	            <tr><th>Date & Time</th><th>Sender Acc</th><th>Receiver Acc</th><th>Amount (&#8377)</th></tr>
	        </thead>
	        <tbody>
